...
create table tb_user (id int8 generated by default as identity, email varchar (255), primarykey (id));
alter table if exists tb_score add constraint Fk23yhb6qop0f6nb72hcornm3cv foreign key (movie_id) references tb_movie;
